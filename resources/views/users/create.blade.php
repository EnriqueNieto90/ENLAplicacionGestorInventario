        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500">
                    Alta de cuentas internas para empleados y administradores.
                </p>
            </div>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-2xl border border-slate-200 bg-white p-6">
                <form method="POST" action="{{ route('users.store') }}" class="space-y-6" novalidate>
                    @csrf
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-slate-500">
                            El empleado puede consultar el inventario. El administrador puede gestionar artículos, categorías, stock y usuarios.
                        </p>
                    </div>
